                                        ...
                                        <table width="100%" border="0">
                                            ...
                                            <c:forEach var="material" items="${material.rows}">
                                                <tr>
                                                    ...
                                                    <td class="td1"><a href="consultaAnimais.jsp?id=${material.COD_MATERIAL}&acao=delete" onclick="return confirm('Deseja excluir o registro?')"><img src="images/woofunction-icons/close_16.png" value="submit" width="20" height="20"/></a></td>
