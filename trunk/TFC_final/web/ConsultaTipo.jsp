                                        ...
                                        <table width="100%" border="0">
                                            ...
                                            <c:forEach var="tipo" items="${tipo.rows}">
                                                <tr>
                                                    ...
                                                    <td class="td1"><a href="ConsultaTipo.jsp?id=${tipo.COD_TIPO}&acao=delete" onclick="return confirm('Deseja excluir o registro?')"><img src="images/woofunction-icons/close_16.png" value="submit" width="20" height="20"/></a></td>
