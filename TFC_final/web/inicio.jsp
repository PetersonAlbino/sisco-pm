<%-- 
    Document   : inicio
    Created on : 12/08/2012, 01:50:35
    Author     : Claudiozer
--%>
...
<title>e-commerce menu - jQuery menu03</title>
	...
	<!--Following code is all you need for the menu-->
			<div id="wrapper-menu"><!--container for this menu. With this container you can position it where you want in your layaout-->
			  <ul id="nav" name="nav">
					<li id="item1" class="fade"><a href="teste.jsp" title="keywords for SEO">home</a></li>
					<li id="item2" class="fade"><a href="#" title="keywords for SEO">services</a></li>
					<li id="item3" class="fade"><a class="big-menu-launcher" href="#" title="keywords for SEO">products</a></li>
					<li id="item4" class="fade"><a class="big-menu-launcher-stores" href="#" title="keywords for SEO">our stores</a></li>
