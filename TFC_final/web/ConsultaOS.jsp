...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <sql:query var="os" dataSource="${conexao}">
            SELECT * from ORDEMSERVICO LEFT JOIN SITUACAO 
            ON ORDEMSERVICO.COD_SITUACAO = SITUACAO.COD_SITUACAO
        </sql:query>
                                ...
                                <li>
                                    ...
                                    <table width="100%" border="0">
                                        ...
                                        <c:forEach var="os" items="${os.rows}">
                                            <tr>
                                                <td class="td1"><a href="ConsultaOS.jsp?id=${os.COD_OS}&acao=delete" onclick="return confirm('Deseja excluir o registro?')"><img src="images/woofunction-icons/close_16.png" value="submit" width="20" height="20"/></a></td>
                                                ...
                                                <td class="td1"><c:out value="${os.DES_SITUACAO}"/></td>
                                                <td class="td1"><c:out value="${os.DT_GERACAO}"/></td>
                                                <td class="td1"><c:out value="${os.DT_AGENDA}"/></td>
                                                <td class="td1"><a href="queryp.jsp?id=${os.COD_OS}"><img src="images/woofunction-icons/page_text_32.png" value="submit" width="20" height="20"/></a></td>
                                            </tr>
                                        </c:forEach> 
