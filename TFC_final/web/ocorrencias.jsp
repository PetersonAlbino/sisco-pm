...
<title>Cadastros de Bairros</title>
                            ...
                            <form  name="form1" method="post" action="">
                                <ul>
                                    <li>
                                        ...
                                        <label for="forml" ><Strong>Codigo</Strong></label>
					<input type="text" name="cod_ocor" id="cod_ocor">
					<label for="forml" ><strong>Material</strong></label>
                                        <input type="text" name="cod_material" id="cod_material">
                                        <label for="forml" ><strong>Ordem de Servico</strong></label>
                                        <input type="text" name="cod_os" id="cod_os">
                                        <label for="forml" ><strong>Tipo</strong></label>
                                        <input type="text" name="cod_tipo" id="cod_tipo">
                                        <label for="forml" ><strong>Situacao</strong></label>
                                        <input type="text" name="cod_situacao" id="cod_situacao">
                                        <label for="forml" ><strong>Endereco</strong></label>
                                        <input type="text" name="cod_endereco" id="cod_endereco">
